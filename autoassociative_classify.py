...
class ModernHopfield(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_steps=1):
        ...
        self.beta = torch.tensor(1.) #do not train, overparameterized by weights
...
if __name__ == '__main__':
    ...
    hidden_size = 1000
    net = ModernHopfield(input_size, hidden_size)
    ...
    logger = train(net, train_loader, test_loader, epochs=5)
